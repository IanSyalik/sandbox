<style lang="postcss">
  ...
  h1 {
    @apply font-['Rouge_Script'] leading-[1] !text-[5rem] text-transparent px-1 py-0.5;
...
<div class={` text-center ${containerClass}`.trim()}>
  <div class={`relative m-0 flex items-center justify-center text-nw-900 ${contentClass}`.trim()}>
    <h1>Jaan Jana</h1>
    <h1 class="absolute left-1/2 top-1/2 ml-4 -translate-x-1/2 -translate-y-1/2 !text-[10rem] opacity-40">&</h1>
  </div>
</div>
